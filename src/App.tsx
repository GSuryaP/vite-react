...
function App() {
  ...
  { name: 'Python', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3776AB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="9" r="4"></circle><circle cx="15" cy="15" r="4"></circle><path d="M9 13v4h6v-4"></path></svg>' },
  { name: 'C', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#00599C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M15 9a5 5 0 1 0 0 6"></path></svg>' },
  { name: 'C++', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#00599C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9 9a5 5 0 1 0 0 6"></path><path d="M15 10v4"></path><path d="M17 10v4"></path></svg>' },
  { name: 'MongoDB', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#47A248" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2C8 8 8 16 12 22c4-6 4-14 0-20Z"></path><path d="M12 2v20"></path></svg>' },
  ...
  { name: 'Linux', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FCC624" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="7" r="4"></circle><path d="M5 21c0-4 3-7 7-7s7 3 7 7"></path></svg>' },
  { name: 'Docker', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2496ED" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="4" height="4"></rect><rect x="8" y="11" width="4" height="4"></rect><rect x="13" y="11" width="4" height="4"></rect><rect x="8" y="6" width="4" height="4"></rect><path d="M3 16c1 3 4 5 9 5 5 0 8-2 9-5H3Z"></path></svg>' },
  { name: 'Anaconda', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#44A833" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 6a6 6 0 1 1-6 6"></path></svg>' },
